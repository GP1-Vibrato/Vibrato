...
public class ArtistaSecurityConfiguracao {
    ...
    @Autowired
    private ArtistaAutenticacaoService autenticacaoService;
    ...
    public AuthenticationManager authManager(HttpSecurity http) throws Exception {
        ...
        authenticationManagerBuilder.authenticationProvider(new ArtistaAutenticacaoProvider(autenticacaoService, passwordEncoder()));
    ...
    public ArtistaAutenticacaoFilter jwtAuthenticationFilterBean() {
        return new ArtistaAutenticacaoFilter(autenticacaoService, jwtAuthenticationUtilBean());
    }
