...
public class OuvinteSecurityConfiguracao {
    ...
    @Bean
    public SecurityFilterChain ouvinteFilterChain(HttpSecurity http) throws Exception{
    http.headers()
        ...
        http.addFilterBefore(ouvinteJwtAuthenticationFilterBean(), UsernamePasswordAuthenticationFilter.class);

        return http.build();
    }

    @Bean
    public AuthenticationManager ouvinteAuthManager(HttpSecurity http) throws Exception {
    ...
    @Bean
    public OuvinteAutenticacaoFilter ouvinteJwtAuthenticationFilterBean() {
        return new OuvinteAutenticacaoFilter(ouvinteAutenticacaoService, ouvinteJwtAuthenticationUtilBean());
    }

    @Bean
    public GerenciadorTokenJwt ouvinteJwtAuthenticationUtilBean() {
        return new GerenciadorTokenJwt();
    }

    @Bean
    public PasswordEncoder ouvintePasswordEncoder() {
